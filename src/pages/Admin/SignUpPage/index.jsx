        ...
        <div className="wrapper">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input type="text" className="form-control" id="exampleInputName1" placeholder="Enter name" name="name" autoComplete="name" onChange={handleChangeInput} required value={form.name}/>
            ...
            <div className="form-group">
              <label htmlFor="exampleInputPasswordConfirmation">Password Confirmation</label>
              <input type="password" className="form-control" id="exampleInputPasswordConfirmation" placeholder="Password Confirmation" name="password_confirmation" autoComplete="current-password" onChange={handleChangeInput} required value={form.password_confirmation}/>
            </div>
